...
#Pitfall: I need to run this in command line: python launch.py. If I run in this
#IDE, then the directory is not in proper level and it returns error 
...
#%% FOR MANNUAL DEBUGGING
#print THISPATH
#print userfilepath
#print userfilebasename
#THISPATH = "/Users/jieding/Dropbox/MyResearch2016/Hrule_SSM_Pierre/py-smc2-master/"
#userfilepath = "userfile.py"
#userfilebasename = "userfile"
...
if userfile.DATASET == "synthetic":
    ...
    #     xmodule.modelx.generateData(userfile.SYNTHETICDATASIZE, xmodule.modelx.parameters, \
    #             savefilename = syntheticdatasetpath)
    if os.path.isfile(syntheticdatasetpath) and userfile.UseExistingSynthetic:
        xmodule.modelx.loadData(syntheticdatasetpath)
    else:
        print "Overwrite previous or create new synthetic data set ..."
        xmodule.modelx.generateData(userfile.SYNTHETICDATASIZE, xmodule.modelx.parameters, \
                savefilename = syntheticdatasetpath)
